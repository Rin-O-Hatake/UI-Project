...
using Type = Plugins.AltoCityUIPack.Scripts.Dropdown.Type;

namespace Plugins.AltoCityUIPack.Scripts.Gradient
{
    public class GradientCustomAltoCityUIPack : BaseMeshEffect
    {
        #region Fields
